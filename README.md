...
Using the code [here](https://github.com/silvainfm/SatireOrNot/blob/main/OnionOrNot.csv) and the data [here](https://github.com/silvainfm/SatireOrNot/blob/main/final_code.ipynb).
